          ...
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent className="max-w-md">
              <DialogHeader>
                ...
                <DialogDescription>
                  Create a new superhero profile with their details and
                  abilities.
                </DialogDescription>
              </DialogHeader>
            ...
            >
              <div className="relative h-48 bg-gradient-to-br from-blue-100 to-purple-100">
                ...
                <div className="absolute top-2 right-2 flex items-center gap-1 bg-white/90 rounded-full px-2 py-1">
                  <span
                    className={`font-semibold ${getStrengthColor(hero.strength)}`}
                  >
                    {hero.strength}
                  </span>
                  <span className={getStrengthColor(hero.strength)}>
                    {getStrengthIcon(hero.strength)}
                  </span>
                </div>
              </div>
              <CardHeader>
